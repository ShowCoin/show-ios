...
target 'ShowLive' do
    ...
    # 更新jpush，注意手动添加最新的jpush-extension-ios-1.1.0
    pod 'JPush'
    #pod 'iOS-AlipaySDK'
    #pod 'iOS-WechatSDK'
    pod 'GPUImage'
