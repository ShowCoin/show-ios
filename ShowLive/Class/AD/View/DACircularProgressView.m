...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[kThemeRedColor colorWithAlphaComponent:0.3f]];
        [circularProgressViewAppearance setProgressTintColor:kThemeRedColor];
