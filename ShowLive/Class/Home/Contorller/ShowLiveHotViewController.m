...
@interface ShowLiveHotViewController ()

@end

@implementation ShowLiveHotViewController
...
-(UICollectionView*)mainCollectionView{
    if (!_mainCollectionView) {
        ...
        flowlayout.itemSize = CGSizeMake((kMainScreenWidth -1)*0.5, (kMainScreenWidth -1)*0.5);
...
//        _mainCollectionView.contentInset = UIEdgeInsetsMake(kNaviBarHeight, 0, KBottomHeight, 0);
        [_mainCollectionView registerClass:[ShowHotListCell class] forCellWithReuseIdentifier:@"ShowHotListCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ShowHotListCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ShowHotListCell" forIndexPath:indexPath];
    return cell;
}
