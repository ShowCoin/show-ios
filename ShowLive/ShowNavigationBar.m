...
//  EVNavigationBar.m
//
//  Created by JokeSmilzhang on 15/10/30.
//  Copyright © 2018年 www.evrental.cn Show. All rights reserved.
//
...
- (void)setDefaultStyle {
    ...
    [_leftView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self).with.offset(20+KTopHeight);
...
{
    [self setRightTitle:title titleColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:15.0f]];
}
...
- (void)setNavigationColor:(NavigationColorType )type;
{
    ...
    switch (style) {
        ...
        case NavigationColorwihte:
            ...
            _linView.backgroundColor = kTextGrayColor;
