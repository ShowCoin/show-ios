...
#import "UIViewController+RightSlide.h"
#import <objc/runtime.h>

@implementation UIViewController (RightSlide)
...
-(void)didPanEvent:(UIPanGestureRecognizer *)recognizer{
    ...
    }else
    {
        ...
        if (CGRectGetMinX(self.view.frame) >= kMainScreenWidth + CGRectGetWidth(self.view.frame) * 0.3) {
...
- (void)hide
{
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut  animations:^{
        self.view.frame = CGRectMake(kMainScreenWidth + CGRectGetWidth(self.view.frame), 0, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame));
        self.maskView.alpha = 0;
