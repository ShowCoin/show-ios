...
typedef NS_ENUM(NSUInteger, CYPromptCoverViewLayoutType) {
    CYPromptCoverViewLayoutTypeUP0,
    ...
    CYPromptCoverViewLayoutTypeRightDownPay,
    CYPromptCoverViewLayoutTypeShootUp,
    CYPromptCoverViewLayoutTypeRightUP,
    CYPromptCoverViewLayoutTypeRightUPWrite,
    CYPromptCoverViewLayoutTypeHomeTitle,
    CYPromptCoverViewLayoutTypeRightUPEdit,
    CYPromptCoverViewLayoutTypeCenter,
    CYPromptCoverViewLayoutTypeLeftDown1,
    CYPromptCoverViewLayoutHomeCenter,
    CYPromptCoverViewLayoutRecordCenter,
    CYPromptCoverViewLayoutWorkCenter,
