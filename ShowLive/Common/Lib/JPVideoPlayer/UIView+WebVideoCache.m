...
- (void)jp_playVideoWithURL:(NSURL *)url{
    [self jp_playVideoWithURL:url options:JPVideoPlayerMutedPlay|JPVideoPlayerContinueInBackground | JPVideoPlayerLayerVideoGravityResizeAspectFill  progress:nil completed:nil];
}
...
- (void)jp_playVideoMutedDisplayStatusViewWithURL:(NSURL *)url{
    [self jp_playVideoWithURL:url options:JPVideoPlayerMutedPlay|JPVideoPlayerContinueInBackground  | JPVideoPlayerLayerVideoGravityResizeAspectFill | JPVideoPlayerMutedPlay progress:nil completed:nil];
}
