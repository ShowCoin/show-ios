...
@property (assign, nonatomic) BOOL canHideCancelButton;
@property (assign, nonatomic) NSInteger leadingOrTailMargin;
@property (assign, nonatomic) NSInteger searchHeight;
@property (assign, nonatomic) NSInteger hiddenCancelbutton;
